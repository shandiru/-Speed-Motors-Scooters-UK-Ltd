...
const services = [
  {
    ...
    desc: "Professional window tinting for enhanced privacy, UV protection, and a sleek look for your vehicle.",
    image: "/window-tinting.avif",
    path: "/services/window-tinting",
  },
  {
    title: "CAR WRAPPING",
    desc: "Complete color changes and custom vinyl wraps to protect your paint and personalize your ride.",
    image: "/car-wrapping.avif",
    path: "/services/car-wrapping",
  },
  {
    title: "MOTOR & SCOOTER SALES",
    desc: "Expert sales and tuning services for scooters and motorcycles, ensuring peak performance on London streets.",
    image: "/scooter-sales.avif",
    path: "/services/scooter-sales",
  },
];
